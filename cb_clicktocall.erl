...
originate_call(Contact, JObj, AccountId) ->
    ...
    CCVs = [{<<"Account-ID">>, AccountId}
            ,{<<"Auto-Answer">>, <<"true">>}
            ,{<<"Retain-CID">>, <<"true">>}
            ,{<<"Outbound-CID">>, wh_json:get_value(<<"caller_id_number">>, JObj)} %%add by wangkai
    ...
    Request = props:filter_undefined(
                [{<<"Application-Name">>, <<"transfer">>}
                 ...
                 ,{<<"Custom-Channel-Vars">>, wh_json:from_list(CCVs)}
                 ,{<<"Export-Custom-Channel-Vars">>, [<<"Account-ID">>, <<"Retain-CID">>, <<"Authorizing-ID">>, <<"Authorizing-Type">>,<<"Outbound-CID">>]} %%mod by wangkai
